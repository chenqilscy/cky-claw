"""内部消息格式转换——Kasaya Message ↔ LiteLLM/OpenAI 格式。"""
...
from kasaya.model.provider import ModelChunk, ModelResponse, ToolCall, ToolCallChunk


def messages_to_litellm(messages: list[Message]) -> list[dict[str, Any]]:
    """将 Kasaya Message 列表转换为 LiteLLM/OpenAI 消息格式。"""
