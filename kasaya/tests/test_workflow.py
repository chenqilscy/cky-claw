...
from kasaya.tracing.span import SpanType
from kasaya.workflow.config import WorkflowRunConfig
from kasaya.workflow.engine import AgentNotFoundError, WorkflowEngine
from kasaya.workflow.evaluator import UnsafeExpressionError, evaluate
from kasaya.workflow.result import WorkflowStatus
...
class TestLinearDAG:
    ...
    async def test_context_flow(self) -> None:
        ...
        import kasaya.workflow.engine as engine_mod
...
class TestTemplateRendering:
    ...
    async def test_template_substitution(self) -> None:
        ...
        assert result.status == WorkflowStatus.COMPLETED
        assert captured_input[0] == "Analyze: What is Kasaya?"
