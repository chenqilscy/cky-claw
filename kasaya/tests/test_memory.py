...
class TestModuleExports:
    def test_framework_init_exports(self) -> None:
        import kasaya
        assert hasattr(kasaya, "MemoryType")
        assert hasattr(kasaya, "MemoryEntry")
        assert hasattr(kasaya, "MemoryBackend")
        assert hasattr(kasaya, "InMemoryMemoryBackend")
        assert hasattr(kasaya, "MemoryRetriever")

    def test_memory_init_exports(self) -> None:
        from kasaya.memory import (
            DecayMode,
            InMemoryMemoryBackend,
            MemoryBackend,
            MemoryEntry,
