...
- Name: smoke.spec.ts >> 认证后页面 >> Checkpoints 检查点页可加载
- Location: frontend\e2e\smoke.spec.ts:165:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/checkpoints
Call log:
  - navigating to "http://fn.cky:3000/checkpoints", waiting until "load"
