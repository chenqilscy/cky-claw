...
- Name: smoke.spec.ts >> 认证后页面 >> Providers 模型提供商页可加载
- Location: frontend\e2e\smoke.spec.ts:70:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/providers
Call log:
  - navigating to "http://fn.cky:3000/providers", waiting until "load"
