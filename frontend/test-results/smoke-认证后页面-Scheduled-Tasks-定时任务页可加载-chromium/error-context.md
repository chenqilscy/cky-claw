...
- Name: smoke.spec.ts >> 认证后页面 >> Scheduled Tasks 定时任务页可加载
- Location: frontend\e2e\smoke.spec.ts:150:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/scheduled-tasks
Call log:
  - navigating to "http://fn.cky:3000/scheduled-tasks", waiting until "load"
