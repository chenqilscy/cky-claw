...
- Name: smoke.spec.ts >> 认证后页面 >> Roles 角色管理页可加载
- Location: frontend\e2e\smoke.spec.ts:125:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/roles
Call log:
  - navigating to "http://fn.cky:3000/roles", waiting until "load"
