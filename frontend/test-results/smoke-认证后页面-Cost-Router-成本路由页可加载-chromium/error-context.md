...
- Name: smoke.spec.ts >> 认证后页面 >> Cost Router 成本路由页可加载
- Location: frontend\e2e\smoke.spec.ts:160:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/cost-router
Call log:
  - navigating to "http://fn.cky:3000/cost-router", waiting until "load"
