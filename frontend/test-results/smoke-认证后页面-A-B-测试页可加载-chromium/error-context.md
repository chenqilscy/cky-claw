...
- Name: smoke.spec.ts >> 认证后页面 >> A/B 测试页可加载
- Location: frontend\e2e\smoke.spec.ts:49:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/ab-test
Call log:
  - navigating to "http://fn.cky:3000/ab-test", waiting until "load"
