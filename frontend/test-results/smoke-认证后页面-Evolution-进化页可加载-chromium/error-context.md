...
- Name: smoke.spec.ts >> 认证后页面 >> Evolution 进化页可加载
- Location: frontend\e2e\smoke.spec.ts:140:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/evolution
Call log:
  - navigating to "http://fn.cky:3000/evolution", waiting until "load"
