...
- Name: smoke.spec.ts >> 认证后页面 >> Audit Logs 审计日志页可加载
- Location: frontend\e2e\smoke.spec.ts:120:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/audit-logs
Call log:
  - navigating to "http://fn.cky:3000/audit-logs", waiting until "load"
