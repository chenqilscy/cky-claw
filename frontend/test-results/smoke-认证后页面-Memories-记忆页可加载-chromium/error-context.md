...
- Name: smoke.spec.ts >> 认证后页面 >> Memories 记忆页可加载
- Location: frontend\e2e\smoke.spec.ts:95:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/memories
Call log:
  - navigating to "http://fn.cky:3000/memories", waiting until "load"
