...
- Name: smoke.spec.ts >> 认证后页面 >> Tool Groups 工具组页可加载
- Location: frontend\e2e\smoke.spec.ts:90:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/tool-groups
Call log:
  - navigating to "http://fn.cky:3000/tool-groups", waiting until "load"
