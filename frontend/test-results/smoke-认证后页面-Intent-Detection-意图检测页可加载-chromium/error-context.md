...
- Name: smoke.spec.ts >> 认证后页面 >> Intent Detection 意图检测页可加载
- Location: frontend\e2e\smoke.spec.ts:170:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/intent
Call log:
  - navigating to "http://fn.cky:3000/intent", waiting until "load"
