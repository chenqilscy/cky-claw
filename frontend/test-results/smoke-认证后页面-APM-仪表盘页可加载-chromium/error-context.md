...
- Name: smoke.spec.ts >> 认证后页面 >> APM 仪表盘页可加载
- Location: frontend\e2e\smoke.spec.ts:155:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/apm
Call log:
  - navigating to "http://fn.cky:3000/apm", waiting until "load"
