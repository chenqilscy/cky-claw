...
- Name: smoke.spec.ts >> 认证后页面 >> Templates 模板页可加载
- Location: frontend\e2e\smoke.spec.ts:105:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/templates
Call log:
  - navigating to "http://fn.cky:3000/templates", waiting until "load"
