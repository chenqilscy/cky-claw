...
- Name: smoke.spec.ts >> 认证后页面 >> Workflows 工作流页可加载
- Location: frontend\e2e\smoke.spec.ts:110:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/workflows
Call log:
  - navigating to "http://fn.cky:3000/workflows", waiting until "load"
