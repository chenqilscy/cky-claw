...
- Name: smoke.spec.ts >> 关键页面加载 >> 404 页面显示未找到提示
- Location: frontend\e2e\smoke.spec.ts:22:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/nonexistent-page-xyz
Call log:
  - navigating to "http://fn.cky:3000/nonexistent-page-xyz", waiting until "load"
