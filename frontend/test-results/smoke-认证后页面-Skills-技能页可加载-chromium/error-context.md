...
- Name: smoke.spec.ts >> 认证后页面 >> Skills 技能页可加载
- Location: frontend\e2e\smoke.spec.ts:100:3

# Error details

```
Error: page.goto: net::ERR_HTTP_RESPONSE_CODE_FAILURE at http://fn.cky:3000/skills
Call log:
  - navigating to "http://fn.cky:3000/skills", waiting until "load"
