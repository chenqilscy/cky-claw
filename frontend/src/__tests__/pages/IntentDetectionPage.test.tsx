...
describe('IntentDetectionPage', () => {
  ...
  it('calls detect API and shows drifted result', async () => {
    ...
    fireEvent.change((textareas[0] as HTMLTextAreaElement), { target: { value: 'test original' } });
    fireEvent.change((textareas[1] as HTMLTextAreaElement), { target: { value: 'test current' } });
  ...
  it('shows not-drifted result', async () => {
    ...
    const textareas = container.querySelectorAll('textarea');
    fireEvent.change((textareas[0] as HTMLTextAreaElement), { target: { value: 'a' } });
    fireEvent.change((textareas[1] as HTMLTextAreaElement), { target: { value: 'b' } });
  ...
  it('displays keyword tags', async () => {
    ...
    const textareas = container.querySelectorAll('textarea');
    fireEvent.change((textareas[0] as HTMLTextAreaElement), { target: { value: 'x' } });
    fireEvent.change((textareas[1] as HTMLTextAreaElement), { target: { value: 'y' } });
