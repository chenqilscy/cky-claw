...
class TestModuleExports:
    def test_skills_package_exports(self) -> None:
        import ckyclaw_framework.skills as mod
    ...
    def test_top_level_exports(self) -> None:
        ...
        assert hasattr(ckyclaw_framework, "Skill")
        assert hasattr(ckyclaw_framework, "SkillCategory")
        assert hasattr(ckyclaw_framework, "SkillRegistry")
        assert hasattr(ckyclaw_framework, "SkillNotFoundError")
        assert hasattr(ckyclaw_framework, "SkillInjector")
