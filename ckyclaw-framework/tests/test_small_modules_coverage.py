...
class TestTeamAsTool:
    ...
    async def test_team_as_tool_runs(self) -> None:
        ...
        with patch("ckyclaw_framework.team.team_runner.TeamRunner.run", new_callable=AsyncMock) as mock_run:
...
class TestFunctionToolSchemaGeneration:
    ...
    def test_schema_gen_with_broken_hints(self) -> None:
        ...
        from ckyclaw_framework.tools.function_tool import _generate_parameters_schema
        ...
        with patch("ckyclaw_framework.tools.function_tool.get_type_hints", side_effect=Exception("bad")):
