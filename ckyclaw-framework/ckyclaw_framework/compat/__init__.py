"""CkyClaw Framework — OpenAI Agents SDK 兼容层。

提供适配器，将 OpenAI Agents SDK 风格的 Agent 定义
无缝转换为 CkyClaw Framework 原生对象并运行。

用法示例::

    from ckyclaw_framework.compat import (
        from_openai_agent,
        from_openai_tool,
        from_openai_handoff,
    ...
    ckyclaw_agent = from_openai_agent(sdk_agent_dict)
