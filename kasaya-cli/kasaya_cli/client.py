...
class KasayaClient:
    """轻量级 HTTP 客户端，封装 Kasaya Backend REST API。"""

    def __init__(self, base_url: str | None = None, token: str | None = None) -> None:
        self.base_url = (base_url or os.environ.get("KASAYA_URL", "http://localhost:8000")).rstrip("/")
        self.token = token or os.environ.get("KASAYA_TOKEN", "")
