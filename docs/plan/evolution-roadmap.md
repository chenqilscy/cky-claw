...
> 基于 Harness 理论、NextCrab 工程实践、Hermes Agent 自改进框架三份对比报告，结合 Kasaya 现有能力矩阵，制定分阶段演进计划。
>
...
Kasaya 定位为 **Python 生态 AI Agent 管理与运行平台**，面向中国企业 AI 团队。以下四项是核心竞争力，必须持续加固：
...
| 能力域 | Harness 理论 | NextCrab 实践 | Hermes 特色 | Kasaya 现状 | 差距等级 |
|--------|:----------:|:----------:|:----------:|:----------:|:------:|
...
完成全部 7 个 Phase 后的 Kasaya 能力预期：

| 维度 | 当前 Kasaya | 完成后 Kasaya | NextCrab | Hermes |
|------|:----------:|:------------:|:-------:|:-----:|
| 上下文管理 | ⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐ |
| 记忆系统 | ⭐⭐ | ⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ |
| LLM 容错 | ⭐ | ⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐ |
...
| 报告 | 路径 | 核心发现 |
|------|------|---------|
| Harness 理论 + Kasaya 映射 | `docs/compare-report/harnees-kasaya.md` | 5 层架构 + Cache-First + 反模式 |
| NextCrab vs Kasaya 深度对比 | `docs/compare-report/NextCrab vs Kasaya 架构对比分析.md` | 10 项可借鉴方向 |
