...
│   ├── Kasaya PRD v2.0.md                    — 总纲（一~三章 + 附录 + 索引）
│   ├── Kasaya PRD-Agent编排 v2.0.md          — 分册：四~六章
│   ├── Kasaya PRD-企业能力 v2.0.md           — 分册：七~十章
│   ├── Kasaya PRD-基础设施 v2.0.md           — 分册：十一~十五章
│   ├── Kasaya Framework Design v2.0.md       — 框架设计
│   ├── Kasaya API Design v1.2.md             — API 接口设计
│   ├── Kasaya Application Design v1.2.md     — 应用层技术设计
│   ├── Kasaya Data Model v1.3.md             — 数据模型设计
│   ├── Kasaya Workflow Engine Design v1.0.md — 工作流引擎设计
│   ├── Kasaya Rust 重写可行性分析 v1.0.md     — Rust 重写可行性分析
│   ├── Kasaya 前端 UI 优化方案 v1.0.md        — 前端 UI 优化方案
│   ├── Kasaya 演进方向分析 v1.0.md            — 演进方向分析
...
│   ├── harnees-kasaya.md           — Harness vs Kasaya 对比
│   └── NextCrab vs Kasaya 架构对比分析.md
│
...
├── kasaya-cli-guide.md             — CLI 命令行工具使用说明
...
```
详见《Kasaya 数据模型详细设计 v1.3》第三章。
详见《Kasaya Framework Design v2.0》4.5 节。
```
...
|-----------|-----------|
| PRD | Kasaya PRD |
| Framework Design | Kasaya Framework Design |
| API Design | Kasaya API 接口设计 |
| Application Design | Kasaya 应用层技术设计方案 |
| Data Model | Kasaya 数据模型详细设计 |
...
| 文档 | 文件名 | 内部版本 |
|------|--------|---------|
| 产品需求文档（总纲） | Kasaya PRD v2.0.md | v2.0.9 |
| PRD-Agent 编排分册 | Kasaya PRD-Agent编排 v2.0.md | v2.0.8 |
| PRD-企业能力分册 | Kasaya PRD-企业能力 v2.0.md | v2.0.8 |
| PRD-基础设施分册 | Kasaya PRD-基础设施 v2.0.md | v2.0.8 |
| 框架设计 | Kasaya Framework Design v2.0.md | v2.0.0 |
| API 接口设计 | Kasaya API Design v1.2.md | v1.2.0 |
| 应用层技术设计 | Kasaya Application Design v1.2.md | v1.2.0 |
| 数据模型详细设计 | Kasaya Data Model v1.3.md | v1.3.0 |
| 工作流引擎设计 | Kasaya Workflow Engine Design v1.0.md | v1.0.0 |
...
| CLI 使用说明 | kasaya-cli-guide.md | 命令行工具使用指南 |
...
| Rust 重写分析 | Kasaya Rust 重写可行性分析 v1.0.md | Rust 重写可行性评估 |
| 演进方向分析 | Kasaya 演进方向分析 v1.0.md | 项目演进战略 |
